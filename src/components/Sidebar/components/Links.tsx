...
const Links = () => {
  ...
  return (
    <nav className={styles.navbar}>
      <ul>
        <li className={activePeriod === 1 ? `${styles.item} ${styles.active}` : `${styles.item}`} onClick={() => {setActivePeriod(1); handleClick(activePeriod)}}>1º Período</li>
        ...
        <li className={activePeriod === 6 ? `${styles.item} ${styles.active}` : `${styles.item}`} onClick={() => {setActivePeriod(6); handleClick(activePeriod)}}>6º Período</li>
